...
| Doc | Use |
|---|---|
| [decision_log.md](./decision_log.md) | **Locked website and data decisions.** Update whenever a choice is made or a fix encodes a rule. |
| [dashboard_readme.md](./dashboard_readme.md) | How the static site is built, served, and edited. |
| [data_dictionary.md](./data_dictionary.md) | FPL-Core master columns (generated on FPL build). |
